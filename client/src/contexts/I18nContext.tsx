...
const translations: Record<Language, any> = {
  en: {
    ...
    proxies: {
      ...
      syncToDuoPlus: 'Sync to DuoPlus',
      host: 'Host',
      port: 'Port',
      username: 'Username',
      status: 'Status',
      assignedTo: 'Assigned To',
      duoplusStatus: 'DuoPlus Status',
    ...
    devices: {
      ...
      subtitle: 'Manage DuoPlus devices and SNS account linking',
      duoplusDevices: 'DuoPlus Devices',
      running: 'Running',
      linked: 'Linked',
      ...
      powerOn: 'Power On',
      powerOff: 'Power Off',
      noDevices: 'No devices registered in DuoPlus',
    },
    deviceMonitor: {
      title: 'Device Monitoring',
      subtitle: 'Real-time monitoring of DuoPlus devices',
      checkNow: 'Check Now',
  ...
  ja: {
    ...
    proxies: {
      ...
      uploadCSV: 'アップロード',
      autoAssign: '自動割り当て',
      syncToDuoPlus: 'DuoPlusに同期',
      host: 'ホスト',
      port: 'ポート',
      username: 'ユーザー名',
      status: 'ステータス',
      assignedTo: '割り当て先',
      duoplusStatus: 'DuoPlus設定状況',
    ...
    devices: {
      title: 'デバイス管理',
      subtitle: 'DuoPlusデバイスとSNSアカウントの紐付けを管理',
      duoplusDevices: 'DuoPlusデバイス',
      running: '起動中',
      linked: '紐付け済み',
      ...
      powerOn: '起動',
      powerOff: '停止',
      noDevices: 'DuoPlusにデバイスが登録されていません',
    },
    deviceMonitor: {
      title: 'デバイス監視',
      subtitle: 'DuoPlusデバイスの稼働状況をリアルタイムで監視',
      checkNow: '今すぐチェック',
      totalDevices: '総デバイス数',
      runningCount: '稼働中',
      stoppedCount: '停止中',
  ...
  zh: {
    ...
    proxies: {
      ...
      uploadCSV: '上传',
      autoAssign: '自动分配',
      syncToDuoPlus: '同步到DuoPlus',
      host: '主机',
      port: '端口',
      username: '用户名',
      status: '状态',
      assignedTo: '分配给',
      duoplusStatus: 'DuoPlus设置状态',
      deviceStatus: '设备状态',
      available: '可用',
      assigned: '已分配',
      configured: '已配置',
    ...
    devices: {
      title: '设备管理',
      subtitle: '管理DuoPlus设备和SNS账户绑定',
      duoplusDevices: 'DuoPlus设备',
      running: '运行中',
      linked: '已绑定',
      ...
      powerOn: '开机',
      powerOff: '关机',
      noDevices: 'DuoPlus中未注册设备',
    },
    deviceMonitor: {
      title: '设备监控',
      subtitle: '实时监控DuoPlus设备运行状态',
      checkNow: '立即检查',
      totalDevices: '总设备数',
      runningCount: '运行中',
      stoppedCount: '已停止',
